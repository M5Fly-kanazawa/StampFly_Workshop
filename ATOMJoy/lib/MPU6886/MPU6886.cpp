...
void MPU6886::filterset(void)
{
  ...
  //Gyro
  //F_CHOICE_B
  I2C_Read_NBytes(MPU6886_ADDRESS, MPU6886_GYRO_CONFIG, 1, &data);
  ...
  //DLPG_CFG
  I2C_Read_NBytes(MPU6886_ADDRESS, MPU6886_CONFIG, 1, &data);
  Serial.printf("CONFIG %d\r\n", data);
  data = (data&0b11111100)|filter_config;
  ...
  I2C_Read_NBytes(MPU6886_ADDRESS, MPU6886_ACCEL_CONFIG2, 1, &data);
  Serial.printf("ACCEL_CONFIG2 %d\r\n", data);
  data = (data & 0b11110111) | filter_config;
